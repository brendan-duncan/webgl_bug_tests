...
import { Epsilon, RotationOrder, DegreeToRadian, RadianToDegree } from "./math.js";
...
export class Matrix4 extends Float32Array {
    ...
    constructor() {
        if (arguments.length) {
            if (arguments.length == 1 && !arguments[0]) {
                ...
                this[10] = x;
                this[15] = x;
            } else if (arguments.length == 16 && Loki.isNumber(arguments[0])) {
                super(16);
                this[0] = arguments[0];
                this[1] = arguments[1];
                this[2] = arguments[2];
     ...
     * @param {Matrix3?} out 
     * @return {Matrix3} The Matrix3 containing the upper 3x3 portion of this matrix.
     */
    getMatrix3(out) {
        out = out || new Matrix3();
        const m = this;
    ...
    setQuaternion() {
        const numArgs = arguments.length;
        const q = numArgs == 1 ? arguments[0] : arguments;
        const out = this;
        // Quaternion math
     ...
     * @param {Vector3} t The translation of the matrix.
     * @param {Vector3} q The quaternion orientation of the matrix.
     * @param {Vector3} s The scale of the matrix.
     */
    setTransform(t, q, s) {
        const out = this;
        // Quaternion math
     ...
     * @param {Matrix3?} out optional storage for the results.
     * @return {Matrix3}
     */
    invertToMatrix3(out) {
        out = out || new this.Matrix3();
        const m = this;
     ...
     * @param {*} arguments Can either be a Quaternion, or 4 numbers.
     * @return {Matrix4} Returns this matrix.
     */
    rotateQuaternion() {
        const n = arguments.length;
        const q = n == 1 ? arguments[0] : arguments;
        const m = this;
